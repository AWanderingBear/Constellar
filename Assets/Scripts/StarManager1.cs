...
//    void Update()
//    {
//        // Converting mouse pos into world position
//        mousePos = Camera.main.ScreenToWorldPoint(Input.mousePosition);

//        if (drawing == true)
//        {
//            // Keep updating the line 
//            updateLink(currentlySelectedStar, mousePos);
...
//        Debug.DrawRay(attemptedRay.origin, attemptedRay.direction);

//        Debug.Log("Ray: " + attemptedRay);
...
//    // Try a line initially that will follow the mouse
...
//        //Create the Game Object
//        GameObject tempConnection = (GameObject)Instantiate(connectingLinePrefab, newLinePosition, rotationQuat);
...
//    // The line position is constantly updated, following the mouse
